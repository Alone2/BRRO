...
public class Teams  implements CommandExecutor {
	...
	public boolean onCommand(CommandSender p, Command command, String label, String[] args) {
		...
		for (int i = 0; i < plugin.getConfig().getInt("team"); i++) { 
			...
			String config = plugin.getConfig().getString("team" + String.valueOf(e) + ".player1");	
			String myself = plugin.getConfig().getString("Player" + config + ".name");
			...
			int myself_alive = plugin.getConfig().getInt("Player" + config + ".alive");
			...
			String PlayerId2 = plugin.getConfig().getString("team" + String.valueOf(e) + ".player2");
			...
			int teamm8UUID_alive = plugin.getConfig().getInt("Player" + PlayerId2 + ".alive");
